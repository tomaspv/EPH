...
```{r}
#HISTOGRAMA
edadGraficoHistograma <- hist(ds$EDAD,xlab = "Edad", ylab = "Observaciones", col ="tomato")
edadGraficoHistograma2 <- qplot(x=EDAD, data = ds, bins =20, geom= 'histogram')

edadGraficoHistograma
edadGraficoHistograma2
...
```{r}
#Usando QPLOT
AglomeracionGraficoBarras <- qplot(x=AGLOMERADO, data = ds, bins =20, geom= 'bar', ylab = "Cantidad Media poblacion")
...
qplot(x=AGLOMERADO, data = ds, bins =20, geom= 'bar', ylab = "Cantidad Media poblacion")
```
...
regionGraficoBarras <- qplot(x=REGION, data = ds, bins =20, geom= 'bar', ylab = "Cantidad Media poblacion", fill = Nombre_Regiones)
regionGraficoBarras
...
```{r}
sexoGraficoBarras <- qplot(ds$SEXO,geom = 'bar', xlab = "Tipo Sexo", ylab = "Cantidad Media")
sexoGraficoBarras
...
```{r}
estadoCivilGraficoBarras <- qplot(ds$ESTADO_CIVIL,geom = 'bar', xlab = "Tipo estado civil", ylab = "Cantidad Media")
...
```{r}
leerYescribirGraficoBarras <- qplot(ds$LEER_Y_ESCRIBIR,geom = 'bar', xlab = "Sabe leer y escribir", ylab = "Cantidad Media")
...
rango_Edad <- ds$EDAD
tipo_Sexo <- ds$SEXO
ggplot(ds, aes(fill= rango_IPCF, x=tipo_Sexo, y=rango_Edad)) +  geom_bar(position="dodge", stat="identity", col= 'black')
```

ESTADOACTIVIDAD
#Distribucion por estado
```{r}
TipoActividadGraficoBarras <- qplot(ds$ESTADO,geom = 'bar', xlab = "Tipo", ylab = "Cantidad Media")
...
```{r}
nivelEducativoGraficoBarras <- qplot(ds$NIVEL_ED,geom = 'bar', xlab = "Tipo", ylab = "Cantidad Media")
...
```{r}
GestionEstablecimientoGraficoBarras <- qplot(ds$GESTION,geom = 'bar', xlab = "Tipo", ylab = "Cantidad Media")
